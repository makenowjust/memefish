...
var lexerWrongTestCase = []struct {
	...
	{`"\0`, 1, 4, "invalid escape sequence: octal escape sequence must be follwed by 3 octal digits"},
	{`"\x`, 1, 4, "invalid escape sequence: hex escape sequence must be follwed by 2 hex digits"},
	{`"\u0`, 1, 5, "invalid escape sequence: \\u must be followed by 4 hex digits"},
